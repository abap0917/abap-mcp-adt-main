...
export declare const TOOL_DEFINITION: {
    readonly name: "LockInterfaceLow";
    readonly available_in: readonly ["onprem", "cloud", "legacy"];
    readonly description: "[low-level] Lock an ABAP interface for modification. Returns lock handle that must be used in subsequent update/unlock operations with the same session_id.";
 ...
 */
export declare function handleLockInterface(context: HandlerContext, args: LockInterfaceArgs): Promise<{
    isError: boolean;
    content: {
        type: string;
        text: any;
...
export {};
//# sourceMappingURL=handleLockInterface.d.ts.map