...
exports.CT_DATA_ELEMENT_UPDATE = exports.ACCEPT_DATA_ELEMENT = void 0;
exports.patchRootAttribute = patchRootAttribute;
exports.patchElement = patchElement;
exports.updateDataElementXml = updateDataElementXml;
exports.ACCEPT_DATA_ELEMENT = 'application/vnd.sap.adt.dataelements.v2+xml, application/vnd.sap.adt.dataelements.v1+xml';
exports.CT_DATA_ELEMENT_UPDATE = 'application/vnd.sap.adt.dataelements.v2+xml; charset=utf-8';
 ...
 */
function patchRootAttribute(xml, attrName, newValue) {
...
async function updateDataElementXml(connection, args, lockHandle) {
    ...
    const currentResp = await connection.makeAdtRequest({
        ...
        method: 'GET',
        timeout: 30_000,
        headers: { Accept: exports.ACCEPT_DATA_ELEMENT },
    });
    let xml = typeof currentResp.data === 'string'
        ? currentResp.data
    ...
    const typeNameVal = typeKind === 'domain'
        ? (args.typeName || args.dataType || '').toUpperCase()
        : (args.typeName || '').toUpperCase();
    if (typeNameVal)
        xml = patchElement(xml, 'dtel:typeName', typeNameVal);
    xml = patchElement(xml, 'dtel:dataType', args.dataType || 'CHAR');
    xml = patchElement(xml, 'dtel:dataTypeLength', String(args.length || 100).padStart(6, '0'));
    xml = patchElement(xml, 'dtel:dataTypeDecimals', String(args.decimals || 0).padStart(6, '0'));
    ...
    if (args.searchHelpParameter !== undefined)
        xml = patchElement(xml, 'dtel:searchHelpParameter', args.searchHelpParameter);
    ...
    return connection.makeAdtRequest({
        ...
        data: xml,
        headers: {
            Accept: exports.ACCEPT_DATA_ELEMENT,
            'Content-Type': exports.CT_DATA_ELEMENT_UPDATE,
        },
    });
}
//# sourceMappingURL=ddicDataElementUpdate.js.map