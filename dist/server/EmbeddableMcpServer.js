...
const CustomizingHandlersGroup_js_1 = require("../lib/handlers/groups/CustomizingHandlersGroup.js");
const DebugHandlersGroup_js_1 = require("../lib/handlers/groups/DebugHandlersGroup.js");
...
class EmbeddableMcpServer extends BaseMcpServer_js_1.BaseMcpServer {
    ...
    createDefaultRegistry(exposition, logger) {
        ...
        if (exposition.includes('customizing')) {
            groups.push(new CustomizingHandlersGroup_js_1.CustomizingHandlersGroup(dummyContext));
        }
        if (exposition.includes('debug')) {
            groups.push(new DebugHandlersGroup_js_1.DebugHandlersGroup(dummyContext));
        }
